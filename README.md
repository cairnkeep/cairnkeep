...
skill activation, autonomous loop, or remote access. Pi 0.84.1 is the minimum
validated version; v2.11 also passed the registry-current Pi release and the
documented Node, Bash, and native Windows matrix.
