...
description: Answers repository questions from the compiled wiki first, then canonical raw sources, and optionally writes back a reusable derived answer. Spawned by /wiki-query.
