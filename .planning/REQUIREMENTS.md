...
- [x] **CTX-08**: `context_explore` cross-references its citations against memory (`memory_search`) and the wiki, surfacing which cited ranges have related memory/wiki context. _(from CTX-F1)_
