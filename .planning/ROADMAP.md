...
- [ ] **Phase 4: OpenCode parity operating layer** - Port the memory lifecycle (capture, recall, wakeup) and the `remember`/`recall` commands to OpenCode's plugin model, self-sufficient of Claude assets
...
| 4. OpenCode parity operating layer | v1.1 | Not started | - |
