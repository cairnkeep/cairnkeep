...
- [x] **Phase 4: OpenCode parity operating layer** - Port the memory lifecycle (capture, recall, wakeup) and the `remember`/`recall` commands to OpenCode's plugin model, self-sufficient of Claude assets (completed 2026-07-03)
