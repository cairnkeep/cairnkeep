---
description: Build, query, and inspect the local project graph through Cairnkeep
argument-hint: "[build [--force]|query <term>|status|diff|explain <symbol>|path <from> <to>]"
---
...
Invoke the shell tool exactly once with the corresponding `cairn graph ...`
...
artifacts, spawn another agent, or implement graph logic in this prompt.
