...
description: Runs an advisory lint pass over the derived project wiki and writes a durable report without treating the wiki as canonical.
mode: subagent
---
...
<register_rules>
Mirror every contradiction into the persistent register at `.planning/wiki/CONTRADICTIONS.md`. This is what stops contradictions from leaking:
